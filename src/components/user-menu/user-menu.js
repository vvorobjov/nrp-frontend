...
export default class UserMenu extends React.Component {
  ...
  componentDidMount() {
    this._userRequest = NrpUserService.getCurrentUser().then(
      currentUser => {
      ...
      <div className="user-menu-wrapper">
        <Dropdown>
          <Dropdown.Toggle className="dropdown-toggle" variant="success" id="dropdown-basic">
            ...
            <div className="user-name">{this.state.user ? this.state.user.displayName : 'pending ...'}</div>
          </Dropdown.Toggle>

          <Dropdown.Menu className="dropdown-menu">
            <Dropdown.Item className="dropdown-item" onClick={this.onClickLogout}>
